...
while True:
    ...
    if hands:
        ...
        # #Sent Signal to activate the LED
        # if (bbox1 and not  Hand_Detected) and fingers1.count(1)==1:
        ...
        # elif not bbox1 and Hand_Detected:
...
# Release the webcam and close all windows when the script is stopped
cap.release()
